<template>
  ...
  <div class="fixed top-0 left-0 h-screen lg:block bg-gray-100 border-r z-30 lg:static lg:inset-0"
       :class="sideBarOpen ? '' : 'hidden'" id="main-nav">

    <div class="w-full h-20 border-b flex px-4 items-center mb-8">
      <p class="font-semibold text-3xl text-blue-400 pl-4">PIZZA 33 СМ</p>
    </div>

    <div class="mb-4 px-4">
      <p class="pl-4 text-sm font-semibold mb-1">ГЛАВНОЕ</p>
    ...
    <div class="mb-4 px-4">
      <p class="pl-4 text-sm font-semibold mb-1">Товары</p>
      ...
      <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        ...
        <router-link to="/basket">
          <span class="text-gray-700">Добавить</span>
        </router-link>
      </div>
      ...
      <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        ...
        <router-link to="/product_list">
          <span class="text-gray-700">Посмотреть</span>
        </router-link>
